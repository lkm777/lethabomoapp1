angular.module("lethabo_mo.controllers", [])
...
.controller("side_menusCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	popover_template += "			<a  class=\"item dark-ink\" ng-href=\"#/lethabo_mo/about_us\" ng-click=\"popover.hide()\">";
...
// TODO: about_meCtrl --|-- 
.controller("about_meCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	// TODO: about_meCtrl --|-- $rootScope.mapEnable
	if(typeof google == "undefined"){
		$rootScope.mapEnable = false;
	}else{
		$rootScope.mapEnable = true;
	...
	// TODO: about_meCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: about_meCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: about_meCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: about_meCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `about_me` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: contact_meCtrl --|-- 
.controller("contact_meCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	// TODO: contact_meCtrl --|-- $rootScope.mapEnable
	if(typeof google == "undefined"){
		$rootScope.mapEnable = false;
	}else{
		$rootScope.mapEnable = true;
	...
	// TODO: contact_meCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: contact_meCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: contact_meCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: contact_meCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `contact_me` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: locationCtrl --|-- 
.controller("locationCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	// TODO: locationCtrl --|-- $rootScope.mapEnable
	if(typeof google == "undefined"){
		$rootScope.mapEnable = false;
	}else{
		$rootScope.mapEnable = true;
	...
	// TODO: locationCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: locationCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: locationCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: locationCtrl --|-- $scope.showAuthentication
	...
	// TODO: locationCtrl --|-- $scope.splitArray
	...
	// TODO: locationCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "data/tables/location.json";
	// TODO: locationCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "data/tables/location.json?callback=JSON_CALLBACK";
	// TODO: locationCtrl --|-- $scope.hashURL
	...
	localforage.getItem("data_locations_" + $scope.hashURL, function(err, get_locations){
		if(get_locations === null){
			data_locations =[];
		}else{
			data_locations = JSON.parse(get_locations);
			$scope.data_locations =JSON.parse( get_locations);
			$scope.locations = [];
			for(lastPush = 0; lastPush < 100; lastPush++) {
				if (angular.isObject(data_locations[lastPush])){
					$scope.locations.push(data_locations[lastPush]);
				};
			}
			$timeout(function() {
				$ionicLoading.hide();
	...
	if(data_locations.length === 0 ){
		$timeout(function() {
			...
			// TODO: locationCtrl --|-- $http.get
			$http.get(url_request,http_header).then(function(response) {
				data_locations = response.data;
				$scope.data_locations = response.data;
				// TODO: locationCtrl --|---------- set:localforage
				localforage.setItem("data_locations_" + $scope.hashURL, JSON.stringify(data_locations));
				$scope.locations = [];
				for(lastPush = 0; lastPush < 100; lastPush++) {
					if (angular.isObject(data_locations[lastPush])){
						$scope.locations.push(data_locations[lastPush]);
				...
				$timeout(function() {
					...
					if(response.status ===401){
						// TODO: locationCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: locationCtrl --|------------ error:Message
			...
			$timeout(function() {
				$ionicLoading.hide();
				controller_by_user();
				if(angular.isDefined($scope.data_locations.data)){
					if($scope.data_locations.data.status ===401){
						$scope.showAuthentication();
						return false;
					}
				}
	...
	// TODO: locationCtrl --|-- $scope.doRefresh
	...
	// TODO: locationCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$scope.location = [];
$ionicModal.fromTemplateUrl("location-single.html",{scope: $scope,animation:"slide-in-up"}).then(function(modal){
    $scope.modal = modal;
});
$scope.openModal = function() {
	...
	for (var i = 0; i < data_locations.length; i++) {
		if((data_locations[i].id ===  parseInt(itemID)) || (data_locations[i].id === itemID.toString())) {
			$scope.location = data_locations[i] ;
		}
	}    
    $scope.modal.show();
};
...
$ionicConfig.backButton.text("");
			...
			console.log("%cerror: %cPage: `location` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("portfolioCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	// TODO: portfolioCtrl --|-- $rootScope.mapEnable
	if(typeof google == "undefined"){
		$rootScope.mapEnable = false;
	}else{
		$rootScope.mapEnable = true;
	...
	// TODO: portfolioCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: portfolioCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: portfolioCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: portfolioCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `portfolio` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("terms_and_conditionsCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	// TODO: terms_and_conditionsCtrl --|-- $rootScope.mapEnable
	if(typeof google == "undefined"){
		$rootScope.mapEnable = false;
	}else{
		$rootScope.mapEnable = true;
	...
	// TODO: terms_and_conditionsCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: terms_and_conditionsCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: terms_and_conditionsCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: terms_and_conditionsCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `terms_and_conditions` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
